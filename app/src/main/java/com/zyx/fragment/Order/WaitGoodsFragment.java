 ...
 */
public class WaitGoodsFragment extends BaseFragment implements UpdateUserInfo.onUpdateUserInfo {
        ...
        switch (msg.what) {
            case MyMessageQueue.OK:
                ...
                if (data != null) {
                    ...
                    lv_order_adapter = new ListOrderAdapter(getActivity(), lv_OrderData,"订单详情" ,mListener);
