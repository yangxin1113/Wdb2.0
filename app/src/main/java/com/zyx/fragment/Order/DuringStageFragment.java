...
import com.zyx.fragment.repay.FragmentDetailRepay;
 ...
 */
public class DuringStageFragment extends BaseFragment implements UpdateUserInfo.onUpdateUserInfo {
        ...
        switch (msg.what) {
            case MyMessageQueue.OK:
                ...
                if (data != null) {
                    ...
                    lv_order_adapter = new ListOrderAdapter(getActivity(), lv_OrderData, "我要还款", mListener);
...
//					.setText(getParse().isNull(userInfo.get("integral")));
    ...
    private ListOrderAdapter.MyClickListener mListener = new ListOrderAdapter.MyClickListener() {
        ...
        public void myOnClick(int position, View v) {
            ...
            Intent i = new Intent(getActivity(), FragmentDetailRepay.class);
